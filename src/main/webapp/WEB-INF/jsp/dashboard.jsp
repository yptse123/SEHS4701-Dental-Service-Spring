                ...
                <div class="dashboard-container">
                    ...
                    <aside class="sidebar">
                        <div class="sidebar-header">
                            <h2><i class="fas fa-tooth"></i> HKDC</h2>
                        ...
                        <nav class="sidebar-nav">
                            <ul>
                                <li class="active"><a href="<c:url value='/dashboard'/>"><i
                                            class="fas fa-tachometer-alt"></i> Dashboard</a></li>

                                <!-- Common links for all users -->
                                <li><a href="<c:url value='/profile'/>"><i class="fas fa-user"></i> Profile</a></li>

                                <!-- Patient-specific links -->
                                <sec:authorize access="hasRole('PATIENT')">
                                    <li><a href="<c:url value='/patient/appointments'/>"><i
                                                class="fas fa-calendar-check"></i> My Appointments</a></li>
                                    <li><a href="<c:url value='/patient/book'/>"><i class="fas fa-calendar-plus"></i>
                                            Book Appointment</a></li>
                                </sec:authorize>

                                <!-- Dentist-specific links -->
                                <sec:authorize access="hasRole('DENTIST')">
                                    <li><a href="<c:url value='/dentist/schedule'/>"><i class="fas fa-calendar-alt"></i>
                                            My Schedule</a></li>
                                    <li><a href="<c:url value='/dentist/appointments'/>"><i
                                                class="fas fa-calendar-check"></i> Appointments</a></li>
                                </sec:authorize>

                                <!-- Admin-specific links -->
                                <sec:authorize access="hasRole('ADMIN')">
                                    <li><a href="<c:url value='/admin/clinics'/>"><i class="fas fa-clinic-medical"></i>
                                            Manage Clinics</a></li>
                                    <li><a href="<c:url value='/admin/dentists'/>"><i class="fas fa-user-md"></i> Manage
                                            Dentists</a></li>
                                    <li><a href="<c:url value='/admin/patients'/>"><i class="fas fa-users"></i> Manage
                                            Patients</a></li>
                                    <li><a href="<c:url value='/admin/appointments'/>"><i
                                                class="fas fa-calendar-alt"></i> All Appointments</a></li>
                                </sec:authorize>
                                            ...
                                            <c:choose>
                                                <c:when test="${not empty upcomingAppointments}">
                                                    <table class="appointments-table">
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${upcomingAppointments}"
                                                                var="appointment">
                                                                <tr>
                                                            ...
                                                            <c:when test="${not empty day.schedules}">
                                                                <c:forEach items="${day.schedules}" var="schedule">
                                                                    <div class="schedule-slot">
                                                                        <p class="time">${schedule.startTime} -
                                                                            ${schedule.endTime}</p>
                                                                        <p class="clinic">${schedule.clinic.name}</p>
                                                                    </div>
                                                                </c:forEach>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <p class="no-schedule">No schedule</p>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </div>
                                                </c:forEach>
